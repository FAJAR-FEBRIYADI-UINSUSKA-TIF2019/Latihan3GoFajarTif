    ...
    private void tampilkanpilihan(String pilihan) {
        try {
            ...
            if (pilihan.equalsIgnoreCase("Call Center")) {
                ...
                String smsText = "Rs Tabrani Fajar Febriyadi H/L";
                a = new Intent(Intent.ACTION_VIEW);
                a.setData(Uri.parse("sms:081212341237"));
                a.putExtra("sms_body", smsText);

            } else if (pilihan.equalsIgnoreCase("Driving Direction")) {
                String lokasirs = "google.navigation:q=0.5286026266804889,101.458801885587";
                ...
                a.putExtra(SearchManager.QUERY, "Rumah Sakit Prof. Dr. Tabrani");

            } else if (pilihan.equalsIgnoreCase("Exit")){
                a = new Intent(RSTabrani.this,RS.class);
            }
            startActivity(a);
